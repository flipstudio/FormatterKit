 Pod::Spec.new do |s|
  ...
  s.source    = { :git => 'https://github.com/flipstudio/FormatterKit.git', :tag => "#{s.version}" }
  s.platform  = :ios, '9.0'
  ...
  s.subspec 'PeriodFormatter' do |ss|
    ss.source_files = 'FormatterKit/TTTPeriodFormatter.{h,m}'
    ss.resources = 'Localizations/**'
  end
